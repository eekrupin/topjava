...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getMealsWithExceed(List<ObjectDB> objectsDB) {
        List<Meal>meals = new ArrayList<>(objectsDB.size());
        objectsDB.forEach(objectDB -> {if (objectDB instanceof Meal) meals.add((Meal)objectDB);});
        return MealsUtil.getFilteredWithExceeded(meals, LocalTime.MIN, LocalTime.MAX, 2000);

    }

    public static List<Meal> getFakeMeals(){
