...
public abstract class AbstractJdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal save(Meal meal, int userId){
        return saveThroughTimestamp(meal, userId, false);
    }

    public Meal saveThroughTimestamp(Meal meal, int userId, boolean useTimeStamp) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                .addValue("id", meal.getId())
                .addValue("description", meal.getDescription())
                .addValue("calories", meal.getCalories())
                .addValue("date_time", useTimeStamp ? Timestamp.valueOf(meal.getDateTime()): meal.getDateTime())
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return getBetweenByGeneric(startDate, endDate, userId);
    }
}
