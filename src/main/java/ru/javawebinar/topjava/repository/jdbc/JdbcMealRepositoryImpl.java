...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()){
            ...
            int rows_affected = namedParameterJdbcTemplate.update(
                    "UPDATE meals SET user_id=:user_id, dateTime=:dateTime, description=:description, calories=:calories WHERE id = :id and user_id = :user_id", map);
            if (rows_affected==0) {
                return null;
            }
        }
